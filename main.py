...
async def main():
    ...
    if jq:
        try:
            ...
            jq.run_daily(send_wakeup_poll, time=time(18,41, tzinfo=TZ), chat_id=GROUP_CHAT_ID, name="wakeup_poll")
    ...
    if not jq:
        ...
        asyncio.create_task(fallback_daily_runner(send_wakeup_poll, 18 ,41, ctx=None))
